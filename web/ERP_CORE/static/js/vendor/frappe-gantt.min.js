var Gantt = function () {
    ...
    var e = {
        ...
        to_string(t, e = !1) {
            ...
            const i = this.get_date_values(t).map((t, e) => (1 === e && (t += 1), s(t + "", 6 === e ? 3 : 2, "0"))),
                n = `${i[0]}-${i[1]}-${i[2]}`, a = `${i[3]}:${i[4]}:${i[5]}.${i[6]}`;
            return n + (e ? " " + a : "")
        },
        format(e, i = "YYYY-MM-DD HH:mm:ss.SSS", n = "en") {
            const a = this.get_date_values(e).map(t => s(t, 2, 0)), o = {
                YYYY: a[0],
                MM: s(+a[1] + 1, 2, 0),
                DD: a[2],
                HH: a[3],
        ...
        get_days_in_month(t) {
            const e = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], s = t.getMonth();
            if (1 !== s) return e[s];
    ...
    i.on = ((t, e, s, n) => {
        ...
        if ("object" != typeof e) t.setAttribute(e, s); else for (let s in e) i.attr(t, s, e[s])
    });
    ...
    class o {
        ...
        compute_start_end_date() {
            const t = this.$bar, s = t.getX() / this.gantt.options.column_width,
        ...
        compute_x() {
            const {step: t, column_width: s} = this.gantt.options, i = this.task._start, n = this.gantt.gantt_start;
    ...
    class r {
        ...
        calculate_path() {
            ...
            const s = this.gantt.options.header_height + this.gantt.options.bar_height + (this.gantt.options.padding + this.gantt.options.bar_height) * this.from_task.task._index + this.gantt.options.padding,
                ...
                a = this.from_task.task._index > this.to_task.task._index, o = this.gantt.options.arrow_curve,
                r = a ? 1 : 0, h = a ? -o : o,
    ...
    class p {
        ...
        make_grid_rows() {
            const t = n("g", {append_to: this.layers.grid}), e = n("g", {append_to: this.layers.grid}),
                s = this.dates.length * this.options.column_width, i = this.options.bar_height + this.options.padding;
        ...
        make_grid_ticks() {
            let t = 0, s = this.options.header_height + this.options.padding / 2,
        ...
        make_dates() {
            for (let t of this.get_dates_to_draw()) if (n("text", {
                x: t.lower_x,
                y: t.lower_y,
        ...
        bind_bar_events() {
            ...
            this.bar_being_dragged = null, i.on(this.$svg, "mousedown", ".bar-wrapper, .handle", (h, d) => {
                ...
                r.forEach(e => {
                    ...
                    }) : e.update_bar_position({x: s.ox + s.finaldx}) : a ? o === e.task.id && e.update_bar_position({width: s.owidth + s.finaldx}) : t && e.update_bar_position({x: s.ox + s.finaldx})
                })
